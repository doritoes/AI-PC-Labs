...
6. `pip install torch==2.6.0 torchvision==0.21.0 torchaudio==2.6.0 --index-url https://download.pytorch.org/whl/xpu`
7. Confirm the GPU is ready
...
8. Create a folder named `advanced`
9. In the folder create
    - [config.py](config.py)
    - [train.py](train.py)
