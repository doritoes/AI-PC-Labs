...
NOTE Getting the advanced CAPTCHA model to train on the Mini is like riding a bucking bronco. 16GB RAM is a limiting factor, but with persistence (keep running that GPU cache flush command) you end up with a pretty cool model!
